...
#[doc = "Field `PIN` reader - GPIO number P0.n onto which Reset is exposed"]
pub type PIN_R = crate::FieldReader<u8, u8>;
#[doc = "Field `PIN` writer - GPIO number P0.n onto which Reset is exposed"]
pub type PIN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PSELRESET_SPEC, u8, u8, 6, O>;
...
pub type CONNECT_W<'a, const O: u8> = crate::BitWriter<'a, u32, PSELRESET_SPEC, CONNECT_A, O>;
