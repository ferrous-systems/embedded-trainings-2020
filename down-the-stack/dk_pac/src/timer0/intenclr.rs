...
pub type COMPARE4_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTENCLR_SPEC, COMPARE4_AW, O>;
...
pub type COMPARE5_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTENCLR_SPEC, COMPARE5_AW, O>;
