...
#[doc = "Field `EVENTS_READY` reader - The NFC peripheral is ready to receive and send frames"]
...
#[doc = "Field `EVENTS_READY` writer - The NFC peripheral is ready to receive and send frames"]
...
impl R {
    #[doc = "Bit 0 - The NFC peripheral is ready to receive and send frames"]
    #[inline(always)]
