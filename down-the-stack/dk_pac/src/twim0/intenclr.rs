...
pub type LASTRX_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTENCLR_SPEC, LASTRX_AW, O>;
...
pub type LASTTX_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTENCLR_SPEC, LASTTX_AW, O>;
