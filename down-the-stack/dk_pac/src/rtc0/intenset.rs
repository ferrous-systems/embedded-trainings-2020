...
pub type TICK_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTENSET_SPEC, TICK_AW, O>;
...
pub type OVRFLW_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTENSET_SPEC, OVRFLW_AW, O>;
